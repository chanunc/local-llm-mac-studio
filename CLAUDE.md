...
- **llmster** (LM Studio headless, port 1234, OpenAI only) — fastest end-to-end on agent loops for standard MLX models (3–5× faster than vllm-mlx).
