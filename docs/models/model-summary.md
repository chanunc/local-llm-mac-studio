...
- [Qwen3.6 Family (Hybrid Gated DeltaNet + Vision)](#qwen36-family-hybrid-gated-deltanet--vision) — 9 variants: 35B-A3B 6-bit / 4-bit / Osaurus JANGTQ4 / **prithivMLmods Aggressive Q6_K GGUF (active llmster main, 2026-05-02)**, HauhauCS Aggressive Q6_K_P (prior main), 27B JANG 4M, 27B 6-bit, HauhauCS Balanced Q8_K_P GGUF, 35B Rust LoRA. Full per-variant detail at [`per-model/model-summary-qwen-3-6.md`](per-model/model-summary-qwen-3-6.md)
...
| **prithivMLmods Qwen3.6-35B-A3B Aggressive Q6_K** | MoE 35B/3B + VL | 28.51 GB | GGUF `Q6_K` | **llmster (active main, 2026-05-02)** | [link](per-model/model-summary-qwen-3-6.md#prithivmlmods-qwen36-35b-a3b-uncensored-aggressive-q6_k) |
