...
| **Model (dense 27B uncensored)** | `llmfan46/Qwen3.6-27B-uncensored-heretic-v2-Native-MTP-Preserved-GGUF:Q6_K` — Qwen3.6-27B with 15 native MTP parameters preserved, Heretic v1.3.0 MPOA abliteration. Standard Q6_K GGUF (no imatrix). | `~/.cache/huggingface/hub/models--llmfan46--Qwen3.6-27B-uncensored-heretic-v2-Native-MTP-Preserved-GGUF/snapshots/main/Qwen3.6-27B-uncensored-heretic-v2-Q6_K.gguf` (22.2 GB) — deployed 2026-05-21 |
