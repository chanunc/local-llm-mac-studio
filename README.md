...
| [Qwen3.6-27B Fable-5 LoRA Q6_K](docs/models/per-model/model-summary-qwen-3-6.md#qwen36-27b-fable-5-lora-q6_k) | Dense 27B + runtime LoRA | 22.5 + 0.08 | 256K loaded / 131K benchmarked | Standard agent-trace LoRA over unsloth Q6_K GGUF via `llama-cpp-mainline --lora`; 5/5 smoke, 21.9→13.0 tok/s @ 512→131K, OpenCode browse 28.27 s / search 50.84 s. Near-260K HTTP probe timed out after 600 s |
