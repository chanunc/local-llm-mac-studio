...
- [hotdogs/qwen3.6-27b-fable5-lora + unsloth Qwen3.6-27B Q6_K](../per-model/model-summary-qwen-3-6.md#qwen36-27b-fable-5-lora-q6_k) — 27 B dense Qwen3.6, runtime GGUF LoRA trained on Fable-5 coding-agent traces, served by `llama-cpp-mainline --lora` at 131K practical context — **✅ 5/5 API smoke + 3-turn 27.73 s · OpenCode browse 28.27 s / search 50.84 s · 21.9→13.0 tok/s @ 512→131K**; near-260K HTTP probe timed out — *2026-06-22*
...
| Qwen3.6-27B Fable-5 LoRA Q6_K | `llama-cpp-mainline` :8100 | ✅ **5/5** | 3.59 - 22.90 s | 3.59 - 6.11 s | 27.73 s (runtime GGUF LoRA over unsloth Q6_K base · no MTP · 21.9 → 13.0 tok/s @ 512 → 131K · 131K practical context; near-260K HTTP probe timed out · OpenCode browse 28.27 s / search 50.84 s · [per-model](../per-model/model-summary-qwen-3-6.md#qwen36-27b-fable-5-lora-q6_k)) |
...
| Qwen3.6-27B Fable-5 LoRA Q6_K | `llama-cpp-mainline` :8100 | 28.27 s / 24.77 s | 50.84 s / 47.28 s | 2/2t · `webfetch` · runtime GGUF LoRA over unsloth Q6_K base, no MTP · 21.9→13.0 tok/s @ 512→131K · 131K practical context; near-260K HTTP probe timed out · [per-model](../per-model/model-summary-qwen-3-6.md#qwen36-27b-fable-5-lora-q6_k) |
