...
- **llmster** (LM Studio headless, port 1234, OpenAI only) — **current production main** (2026-05-03): `DavidAU/Qwen3.6-40B-Claude-4.6-Opus-Deckard-Heretic-Uncensored-Thinking-NEO-CODE-Di-IMatrix-MAX-GGUF` `Q6_K` (Heretic recipe: full abliteration + Deckard/PDK, dense 40B, 30.17 GiB). 9/10 mlabonne compliance, visible content channel; browse 18.73 s / search 71.02 s. LM Studio guardrail override required for dense 40B + 131K context load. Prior main (prithivMLmods Aggressive Q6_K, browse 5.05 s leader, 2026-05-02) remains on disk and reloadable. **Also on disk (2026-05-03):** `DavidAU/gemma-4-31B-it-Mystery-Fine-Tune-HERETIC-UNCENSORED-Thinking-Instruct-GGUF` Q6_k (Gemma 4 31B Heretic, 23.47 GiB, 7/10 mlabonne, 24.2 tok/s gen) — benchmarked sidecar, not active main.
