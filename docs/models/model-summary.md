...
- [Qwen3.6 Family (Hybrid Gated DeltaNet + Vision)](#qwen36-family-hybrid-gated-deltanet--vision) — 7 variants: 35B-A3B 6-bit / 4-bit / Osaurus JANGTQ4, 27B JANG 4M, 27B 6-bit, HauhauCS Q8_K_P GGUF, 35B Rust LoRA. Full per-variant detail at [`per-model/model-summary-qwen-3-6.md`](per-model/model-summary-qwen-3-6.md)
...
| HauhauCS Qwen3.6-27B Uncensored Balanced Q8_K_P | Dense 27B + VL | 32 GB | GGUF `Q8_K_P` | llmster | [link](per-model/model-summary-qwen-3-6.md#hauhaucs-qwen36-27b-uncensored-balanced-q8_k_p) |
