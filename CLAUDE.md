...
- **llmster** (LM Studio headless, port 1234, OpenAI only) — **current production main** (2026-05-02): `mradermacher/Qwen3.6-35B-A3B-Uncensored-Aggressive-GGUF` `Q6_K` (prithivMLmods abliteration, MoE 35B/3B + VL, 26.56 GiB). Fastest end-to-end on agent loops for standard MLX / GGUF models; OpenCode browse **5.05 s** (uncensored GGUF browse leader) / search 13.56 s. Prior main (HauhauCS Aggressive Q6_K_P, search 12.01 s) remains on disk and reloadable.
