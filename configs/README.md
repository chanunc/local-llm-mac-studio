...
| **llama-cpp-mtp** | **8100** | llama.cpp sidecar for Qwen3.6 MTP self-drafting and mainline GGUF/runtime-LoRA experiments. MTP runs use `--spec-type draft-mtp`; LoRA runs use mainline `--lora`. See [`docs/servers/llama-cpp-mtp/summary.md`](../docs/servers/llama-cpp-mtp/summary.md) | unsloth/Qwen3.6-27B-MTP-GGUF:UD-Q6_K_XL (~26 GB); hotdogs/qwen3.6-27b-fable5-lora over unsloth Qwen3.6-27B Q6_K (~22.5 GB + 76 MB) | Not needed |
