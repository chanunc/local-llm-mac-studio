...
MacBook / Linux / WSL  ──── LAN ────>  Mac Studio M3 Ultra (<MAC_STUDIO_IP>)
  ...
  Pi                                     vmlx (JANGTQ) :8000     ┘
                                         ...
                                         OpenAI + Anthropic API native (lm-studio + dflash-mlx: OpenAI only; comfyui: web UI only; vmlx-swift-lm: OpenAI + Anthropic + Ollama)
```
...
# Always pass chat_template_kwargs: {"enable_thinking": false} in requests or output lands in message.reasoning.
