...
| [`llama-cpp-mtp/`](llama-cpp-mtp/) | `llama-cpp-mtp` / mainline `llama.cpp` sidecar | `qwen3.6-27b-mtp-ud-q6kxl`; `qwen36-27b-fable5-lora-q6k-131k` (runtime GGUF LoRA over unsloth Qwen3.6-27B Q6_K, 131K practical context) | Sidecar on port 8100. **OpenCode template only.** Covers Qwen3.6 MTP self-drafting and non-MTP mainline llama.cpp runs that need GGUF/runtime-LoRA support. |
