...
- [Qwen3.6 Family (Hybrid Gated DeltaNet + Vision)](#qwen36-family-hybrid-gated-deltanet--vision) — 8 variants: 35B-A3B 6-bit / 4-bit / Osaurus JANGTQ4 / **HauhauCS Aggressive Q6_K_P GGUF (active llmster main)**, 27B JANG 4M, 27B 6-bit, HauhauCS Balanced Q8_K_P GGUF, 35B Rust LoRA. Full per-variant detail at [`per-model/model-summary-qwen-3-6.md`](per-model/model-summary-qwen-3-6.md)
...
| **HauhauCS Qwen3.6-35B-A3B Uncensored Aggressive Q6_K_P** | MoE 35B/3B + VL | 31 GB | GGUF `Q6_K_P` | **llmster (active main, 2026-05-02)** | [link](per-model/model-summary-qwen-3-6.md#hauhaucs-qwen36-35b-a3b-uncensored-aggressive-q6_k_p) |
