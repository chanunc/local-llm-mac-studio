...
| [`ollama/`](ollama/) | `ollama` | `qwen3.6:35b-mlx` (Qwen3.6 35B-A3B MLX via Ollama 0.24) | Sidecar on port 11434. **OpenCode template only.** Apple-Silicon MLX backend; API tool smoke passes 5/5 and OpenCode browse/search pass with `webfetch`. |
