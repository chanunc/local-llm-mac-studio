...
# lm-studio — CURRENT PRODUCTION MAIN (2026-05-10, re-bench 2026-05-11). LM Studio headless
# on port 1234. TrevorJS Gemma 4 31B-it Uncensored Q4_K_M GGUF (Apache 2.0, dense 31B no-think,
# 17.40 GiB resident, decode 30 tok/s @ 512 / 24 tok/s @ 32K, **API smoke 5/5 multi-turn 6.73 s**,
# OpenCode warm-cache browse 6.63 s _(initial 10.08 s)_ / search 30.81 s; refusal-rate
# **harness 6-7/10 (varies on disclaimer wording) / manual 10/10** — all "refused" are
# disclaimer-prefixed complies with full harmful content).
