...
- **llmster** (LM Studio headless, port 1234, OpenAI only) — **current production main** (2026-05-03): `TrevorJS/gemma-4-26B-A4B-it-uncensored-GGUF` `Q8_0` (EGA abliteration on Gemma 4 26B sparse MoE, ~4B active, 25.02 GiB). 8/10 mlabonne compliance; non-thinking instruct; **87.6 tok/s gen, browse 2.93 s 🥇 / search 7.35 s**. LM Studio guardrail override required for initial load. Prior main (DavidAU Qwen3.6-40B Heretic Q6_K, 9/10 mlabonne, browse 18.73 s, 2026-05-03) remains on disk and reloadable. **Also on disk:** `DavidAU/gemma-4-31B-it-Mystery-Fine-Tune-HERETIC-UNCENSORED-Thinking-Instruct-GGUF` Q6_k (Gemma 4 31B Heretic, 23.47 GiB, 7/10 mlabonne, 24.2 tok/s gen) — benchmarked sidecar, not active main.
